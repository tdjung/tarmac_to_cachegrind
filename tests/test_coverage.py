"""Coverage attribution, line aggregation, sparse IDs and overflow references."""
...
class CoverageTests(unittest.TestCase):
    def test_union_same_line_and_failed_ids_excluded(self):
        ...
        self.assertEqual(data[0x104][1:8], [0] * 7)
        self.assertEqual(expand(data[0x104], 8, coverage.sets), successful)
